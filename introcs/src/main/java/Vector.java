...
public class Vector
{
	...
	/*
	 * public Vector(double... data) { N = data.length; // defensive copy so
	 * that client can't alter our copy of data[] this.data = new double[N]; for
	 * (int i = 0; i < N; i++) this.data[i] = data[i]; }
	 */
